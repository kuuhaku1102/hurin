# 【最終版】AI記事自動投稿WordPressサイト構築 指示書
...
| **サーバーのテーマディレクトリパス** | `（例: /home/user/example.com/public_html/wp-content/themes/your-theme-name）` |
...
- **キーワードプール方式**: `scripts/keywords.json` ファイルでキーワードを管理
...
- **アイキャッチ画像**: `scripts/placeholder-image.png` をすべての記事のアイキャッチ画像として設定してください。
